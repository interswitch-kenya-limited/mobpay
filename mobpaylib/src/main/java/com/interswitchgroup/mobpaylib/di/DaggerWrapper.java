...
public class DaggerWrapper {
  ...
  public static MainComponent getComponent(Context context, String clientId, String clientSecret)
  ...
  private static void initComponent(Context context, String clientId, String clientSecret)
      throws PackageManager.NameNotFoundException {
    ApplicationInfo ai =
        context
            .getPackageManager()
