...
public class MobPayActivity extends AppCompatActivity {
  ...
  /**
   * The {@link androidx.core.view.PagerAdapter} that will provide fragments for each of the
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    paymentVm.setOnSuccess(
        new TransactionSuccessCallback() {
          ...
          public void onSuccess(final TransactionResponse transactionResponse) {
            ...
            View dialogView =
                LayoutInflater.from(MobPayActivity.this)
                    .inflate(
            ...
            imageView.setImageDrawable(
                ContextCompat.getDrawable(MobPayActivity.this, R.drawable.happy_face));
            title.setText(R.string.payment_successful_title);
            message.setText(
                "Your transaction was completed successfully, your payment reference is "
                    + transactionResponse.getTransactionOrderId());
                ...
                new DialogInterface.OnShowListener() {
                  ...
                  public void onShow(DialogInterface arg0) {
                    dialog
                        ...
                        .setTextColor(getResources().getColor(R.color.mobpaySuccess));
                  }
                });
            dialog.show();
          }
        });
    paymentVm.setOnFailure(
        new TransactionFailureCallback() {
          ...
          public void onError(final Throwable error) {
            ...
            TextView message = dialogView.findViewById(R.id.dialog_message);
            imageView.setImageDrawable(
                ContextCompat.getDrawable(MobPayActivity.this, R.drawable.sad_face));
    ...
    ActivityMobPayBinding activityMobPayBinding =
        DataBindingUtil.setContentView(this, R.layout.activity_mob_pay);
    ...
    //        final MobPay.PaymentChannel[] allChannels =
    // MobPay.PaymentChannel.class.getEnumConstants();
    final List<MobPay.PaymentChannel> mobPayChannels = MobPay.getConfig().getChannels();
    final MobPay.PaymentChannel[] allChannels =
        mobPayChannels.toArray(new MobPay.PaymentChannel[0]);
          ...
          public void onClick(DialogInterface dialog, int which) {
            switch (which) {
              case DialogInterface.BUTTON_POSITIVE:
                // Yes button clicked
                mobPay
                    .getTransactionFailureCallback()
                    .onError(new Exception(getString(R.string.user_cancelled_payment_message)));
                finish();
                break;
