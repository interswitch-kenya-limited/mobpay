...
public class RSAUtil {
  public static PublicKey getPublicKey(String modulus, String publicExponent) throws Exception {
    RSAPublicKeySpec publicKeyspec =
        new RSAPublicKeySpec(new BigInteger(modulus, 16), new BigInteger(publicExponent, 16));
    KeyFactory factory = KeyFactory.getInstance("RSA");
    return factory.generatePublic(publicKeyspec);
  }

  public static String getAuthDataMerchant(
      PublicKey publicKey,
      String panOrToken,
      String cvv,
      String expiry,
  ...
  public static PublicKey getPublicKey(String base64PublicKey) {
    ...
    try {
      X509EncodedKeySpec keySpec =
          new X509EncodedKeySpec(Base64.decode(base64PublicKey.getBytes(), Base64.NO_WRAP));
  ...
  public static PrivateKey getPrivateKey(String base64PrivateKey) {
    ...
    PKCS8EncodedKeySpec keySpec =
        new PKCS8EncodedKeySpec(Base64.decode(base64PrivateKey.getBytes(), Base64.NO_WRAP));
