...
public class MobPay {
    ...
    public void pay(Merchant merchant, Payment payment, Customer customer, final TransactionSuccessCallback transactionSuccessCallback, final TransactionFailureCallback transactionFailureCallback) {
        ...
        try {
            ...
            String authData = RSAUtil.getAuthDataMerchant(publicKey, "4111111111111111", "2002", "123");
            CardPaymentPayload cardPaymentPayload = new CardPaymentPayload(payment.getAmount(), payment.getTransactionRef(), payment.getTerminalType(), payment.getTerminalId(), payment.getPaymentItem(), merchant.getMerchantId(), authData, payment.getCurrency(), merchant.getDomain());
            cardPaymentPayload.setCustomerInfor(customer.toString());
